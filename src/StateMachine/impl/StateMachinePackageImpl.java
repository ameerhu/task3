...
import StateMachine.UnNamedState;
...
public class StateMachinePackageImpl extends EPackageImpl implements StateMachinePackage {
	 ...
	 * @generated
	 */
	private EClass unNamedStateEClass = null;
	 ...
	 */
	@Override
	public EClass getUnNamedState() {
		return unNamedStateEClass;
	}
	 ...
	 */
	@Override
	public EAttribute getUnNamedState_Name() {
		return (EAttribute)unNamedStateEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EReference getWashingMachine_States() {
		return (EReference)washingMachineEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EReference getWashingMachine_Transitions() {
		return (EReference)washingMachineEClass.getEStructuralFeatures().get(1);
	}
	...
	public void createPackageContents() {
		...
		unNamedStateEClass = createEClass(UN_NAMED_STATE);
		createEAttribute(unNamedStateEClass, UN_NAMED_STATE__NAME);
		...
		createEReference(washingMachineEClass, WASHING_MACHINE__STATES);
		createEReference(washingMachineEClass, WASHING_MACHINE__TRANSITIONS);
	}
	...
	public void initializePackageContents() {
		...
		namedStateEClass.getESuperTypes().add(this.getState());
		unNamedStateEClass.getESuperTypes().add(this.getState());
		...
		initEAttribute(getNamedState_Name(), ecorePackage.getEString(), "name", null, 0, 1, NamedState.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(unNamedStateEClass, UnNamedState.class, "UnNamedState", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getUnNamedState_Name(), ecorePackage.getEString(), "name", null, 0, 1, UnNamedState.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getWashingMachine_States(), this.getState(), null, "states", null, 0, -1, WashingMachine.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getWashingMachine_Transitions(), this.getTransition(), null, "transitions", null, 0, -1, WashingMachine.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
