...
public class StateMachineAdapterFactory extends AdapterFactoryImpl {
	...
	protected StateMachineSwitch<Adapter> modelSwitch =
		new StateMachineSwitch<Adapter>() {
			...
			@Override
			public Adapter caseUnNamedState(UnNamedState object) {
				return createUnNamedStateAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link StateMachine.NamedState <em>Named State</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link StateMachine.UnNamedState <em>Un Named State</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createUnNamedStateAdapter() {
		return null;
	}
	...
	/**
	 * Creates a new adapter for an object of class '{@link StateMachine.WashingMachine <em>Washing Machine</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
