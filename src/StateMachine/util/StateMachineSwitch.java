...
public class StateMachineSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case StateMachinePackage.NAMED_STATE: {
				NamedState namedState = (NamedState)theEObject;
				T result = caseNamedState(namedState);
				if (result == null) result = caseState(namedState);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StateMachinePackage.UN_NAMED_STATE: {
				UnNamedState unNamedState = (UnNamedState)theEObject;
				T result = caseUnNamedState(unNamedState);
				if (result == null) result = caseState(unNamedState);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case StateMachinePackage.WASHING_MACHINE: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Un Named State</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Un Named State</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseUnNamedState(UnNamedState object) {
		return null;
	}
